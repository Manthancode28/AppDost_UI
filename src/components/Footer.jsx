        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-3 text-xl font-bold">AppDost</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#opensource" className="text-gray-300 hover:text-white transition-colors duration-300">Open Source</a></li>
            </ul>
          </div>
